...
\item Prendere il numero come string e poi parsarlo a uint8\_t.
...
\subsection{Stato\_0}
\begin{enumerate}
\item Creare la classe
\item Spostare funzioni da Engine a Stato\_0
...
\subsection{Runner}
\begin{enumerate}
\item Tutto completato fino a questo momento.
\end{enumerate}
