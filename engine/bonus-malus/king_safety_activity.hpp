...
inline static constexpr int64_t KING_SHELTER_STRONG_BONUS = 12;
inline static constexpr int64_t KING_SHELTER_WEAK_BONUS = 7;
inline static constexpr int64_t KING_SHELTER_MISSING_PENALTY = 14;
inline static constexpr int64_t KING_PAWN_STORM_NEAR_PENALTY = 16;
inline static constexpr int64_t KING_PAWN_STORM_FAR_PENALTY = 8;
...
inline static constexpr int64_t KING_OPEN_FILE_PENALTY = 16;
inline static constexpr int64_t KING_FILE_PRESSURE_PENALTY = 9;
inline static constexpr int64_t KING_OPEN_DIAGONAL_PENALTY = 14;
