...
inline static constexpr int64_t STALEMATE_DRAW_PENALTY_MAJOR = 450;

// 1.2 pawn-equivalents
inline static constexpr int64_t STALEMATE_DRAW_PENALTY_MINOR = 120;

// 1.3 pawns (catch smaller advantages a bit earlier)
inline static constexpr int64_t STALEMATE_MATERIAL_THRESHOLD = 130;
