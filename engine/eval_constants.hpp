...
inline int32_t OUTPOST_NEAR_CENTER_FILE_BONUS = 2;
inline int32_t OUTPOST_ADVANCED_RANK_BONUS = 4;
inline int32_t OUTPOST_KING_ZONE_BONUS = 5;
inline int32_t OUTPOST_KEY_SQUARE_BONUS = 3;
inline int32_t COORDINATION_PENALTY = 8;
inline int32_t OUTPOST_BISHOP_BONUS = 10;
inline int32_t OUTPOST_KNIGHT_BONUS = 18;
...
inline int32_t CASTLE_PAWN_SUPPORT_BONUS = 6;
inline int32_t KING_SHELTER_STRONG_BONUS = 10;
inline int32_t KING_SHELTER_WEAK_BONUS = 5;
inline int32_t KING_SHELTER_MISSING_PENALTY = 12;
inline int32_t KING_PAWN_STORM_NEAR_PENALTY = 14;
inline int32_t KING_PAWN_STORM_FAR_PENALTY = 7;
inline int32_t KING_CASTLED_SHIELD_BREAK_PENALTY = 8;
inline int32_t KING_SHELTER_ADVANCE_ONE_PENALTY = 3;
inline int32_t KING_SHELTER_ADVANCE_TWO_PENALTY = 7;
inline int32_t KING_HOOK_PAWN_ATTACKED_PENALTY = 18;
inline int32_t KING_HOOK_PAWN_HANGING_PENALTY = 24;
inline int32_t KING_SAFETY_OPENING_SCALE_PERCENT = 30;
inline int32_t KING_SEMI_OPEN_FILE_PENALTY = 9;
inline int32_t KING_OPEN_FILE_PENALTY = 14;
inline int32_t KING_FILE_PRESSURE_PENALTY = 8;
inline int32_t KING_OPEN_DIAGONAL_PENALTY = 12;
