...
// ===================================================
inline int32_t DOUBLED_PAWN_PENALTY = -8;
inline int32_t ISOLATED_PAWN_PENALTY = -17;
inline int32_t PASSED_PAWN_BONUS = 26;
inline int32_t PAWN_ISLAND_PENALTY = -9;
inline int32_t PAWN_SUPPORT_BONUS = 10;
inline int32_t CANDIDATE_PASSER_BONUS = 10;
inline int32_t CONNECTED_PASSER_BONUS = 22;
inline int32_t BACKWARD_PAWN_PENALTY = -10;
inline int32_t PASSED_PAWN_BLOCKED_PENALTY = -12;
...
inline int32_t CASTLE_PAWN_SUPPORT_BONUS = 9;
inline int32_t KING_SHELTER_STRONG_BONUS = 9;
inline int32_t KING_SHELTER_WEAK_BONUS = 17;
inline int32_t KING_SHELTER_MISSING_PENALTY = 32;
inline int32_t KING_PAWN_STORM_NEAR_PENALTY = 18;
inline int32_t KING_PAWN_STORM_FAR_PENALTY = 11;
inline int32_t KING_CASTLED_SHIELD_BREAK_PENALTY = 10;
inline int32_t KING_SHELTER_ADVANCE_ONE_PENALTY = 3;
inline int32_t KING_SHELTER_ADVANCE_TWO_PENALTY = 4;
inline int32_t KING_HOOK_PAWN_ATTACKED_PENALTY = 13;
inline int32_t KING_HOOK_PAWN_HANGING_PENALTY = 22;
inline int32_t KING_SAFETY_OPENING_SCALE_PERCENT = 30;
inline int32_t KING_SEMI_OPEN_FILE_PENALTY = 16;
inline int32_t KING_OPEN_FILE_PENALTY = 14;
inline int32_t KING_FILE_PRESSURE_PENALTY = 13;
inline int32_t KING_OPEN_DIAGONAL_PENALTY = 8;
