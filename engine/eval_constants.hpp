...
inline int32_t KING_SHELTER_WEAK_BONUS = 12;
inline int32_t KING_SHELTER_MISSING_PENALTY = 23;
inline int32_t KING_PAWN_STORM_NEAR_PENALTY = 13;
...
inline int32_t KING_SEMI_OPEN_FILE_PENALTY = 19;
