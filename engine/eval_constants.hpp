...
// ===================================================
inline int32_t KING_SAFETY_PENALTY = -6;
...
inline int32_t KING_SHELTER_ADVANCE_TWO_PENALTY = 3;
...
inline int32_t KING_SAFETY_SIDE_CAP = 137;
inline int32_t KING_ATTACK_MATERIAL_MIN_SCALE = 37;
