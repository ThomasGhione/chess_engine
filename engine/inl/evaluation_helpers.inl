...
inline void Engine::addPsqt(uint64_t bbWhite, uint64_t bbBlack, const int64_t* table, int64_t& eval) noexcept {
    while (bbWhite) {
...
inline constexpr int64_t Engine::evalInitiativeImpl(uint8_t activeColor) noexcept {
...
template<int Side>
inline constexpr int64_t Engine::evalBadBishopImpl(uint64_t bishops, uint64_t pawns) noexcept {
