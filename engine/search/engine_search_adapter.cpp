...
MoveList<chess::Board::Move> Engine::generateLegalMoves(const chess::Board& b) noexcept {
...
int32_t Engine::quiescenceSearch(
    chess::Board& b,
    int32_t alpha,
    int32_t beta,
    int ply,
    ...
    const int32_t delegatedScore = Searcher::quiescenceSearch(
        b,
        runtime,
        alpha,
        beta,
