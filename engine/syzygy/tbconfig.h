...
static inline uint64_t tb_anti_mask(int sq) {
    ...
    static const uint64_t d[15] = {
        ...
        0x0000000000102040ULL, 0x0000000001020408ULL, 0x0000000102040810ULL,
        0x0000010204081020ULL, 0x0001020408102040ULL, 0x0102040810204080ULL,
        0x0204081020408000ULL, 0x0408102040800000ULL, 0x0810204080000000ULL,
        0x1020408000000000ULL, 0x2040800000000000ULL, 0x4080000000000000ULL,
    };
    return d[(sq >> 3) + (sq & 7)];
}
