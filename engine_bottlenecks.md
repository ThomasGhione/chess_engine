...
| P0 | QSearch costosa | `engine/search/searcher.cpp`, `engine/search/sorter.cpp` | Ogni nodo qsearch valuta, genera tattiche e filtra molte catture con SEE. | Staged tactical move picker: delta pruning economico prima, SEE solo sui candidati rimasti. |
