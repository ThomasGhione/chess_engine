...
[V]| P1 | Micro-overhead nel loop caldo | `engine/search/searcher.cpp` | Per ogni mossa si ripetono controlli su board, promotion, EP, fork threat e material delta non sempre cached. | Reusare metadati gia' calcolati e usare funzioni cached/incrementali. |
